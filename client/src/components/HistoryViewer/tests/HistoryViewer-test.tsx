    ...
    it('returns the node element from each version edge', () => {
      const wrapper = shallow(
        <HistoryViewer
          ...
          page={0}
          schemaUrl={'admin/historyviewer/schema/versionForm/1'}
          recordClass={'Page'}
        />
      );
      const instance = wrapper.instance() as HistoryViewer;
      expect(instance.getVersions().map((version: Version) => version.Version)).toEqual([14, 13]);
    });
  });
  //
